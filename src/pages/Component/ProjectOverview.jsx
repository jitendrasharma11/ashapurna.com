                ...
                <div className="row px-5 mt-5">
                    <div className="col-4">
                        <div className="overview-section p-2 rounded-1 shadow-lg position-relative">
                            <img src="images/Gate_-_4-min-1716280216.jpg" className="img-fluid object-fit-cover" alt="..." />
                            ...
                            <div className="overview-hover rounded-1 shadow-lg position-absolute">
                                ...
                                <div className='d-flex justify-content-between align-items-center mt-2'>
                                    ...
                                    <button className='booking-btn2 mb-0 rounded-1 bg-gradient'>Se All</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-4">
                        <div className="overview-section p-2 rounded-1 shadow-lg position-relative h-100">
                            <img src="images/premium-budget-villas-in-jodhpur-1681994380.webp" className="img-fluid object-fit-cover" alt="..." />
                            <div className="position-absolute overview-btn">
                                <button>Booking Open</button>
                            </div>
                            <div className="overview-hover rounded-1 shadow-lg position-absolute">
                    ...
                    <div className="col-4">
                        <div className="overview-section p-2 rounded-1 shadow-lg position-relative h-100">
                            <img src="images/nanomax-project-thumbnail-1681986809.webp" className="img-fluid object-fit-cover" alt="..." />
                            <div className="position-absolute overview-btn">
                                <button>Booking Open</button>
                            </div>
                            <div className="overview-hover rounded-1 shadow-lg position-absolute">
